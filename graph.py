...
def graphs(mdl,ai,zfi,zmi,psii,ti,thi,dd,edu): 
    ...
    val0= v_reshape(setup,descm,'Values',dec,T-1,0,1)
    ...
    valc0= v_reshape(setup,descc,'Values',dec,T-1,0,1)
    ...
    val0m= v_reshape(setup,descm,'Values',dec,T-1,0,3)
    val1m= v_reshape(setup,descm,'Values',dec,T-1,1,3)
    val2m= v_reshape(setup,descm,'Values',dec,T-1,2,3)
    val3m= v_reshape(setup,descm,'Values',dec,T-1,3,3)
    valc0m= v_reshape(setup,descc,'Values',dec,T-1,0,3)
    valc1m= v_reshape(setup,descc,'Values',dec,T-1,1,3)
    valc2m= v_reshape(setup,descc,'Values',dec,T-1,2,3)
    valc3m= v_reshape(setup,descc,'Values',dec,T-1,3,3)
    ...
    nex1 = setup.all_indices(min(ti+1,T),(zfi,zmi,psig))[0] 
    #plt.plot(psig, entry[ai,0:len(nex1)],'k',linewidth=0.2, label='Couple formed') 
    plt.plot(psig0, val0f[ai,zfi,zmi,0:len(psig),inde,ti+1],'k',linewidth=0.2, label='vm0f') 
    plt.plot(psig1, val1f[ai,zfi,zmi,0:len(psig),inde,ti+1],'b',linewidth=0.2, label='vm1f') 
    plt.plot(psig2, val2f[ai,zfi,zmi,0:len(psig),inde,ti+1],'r',linewidth=0.2, label='vm2f') 
    plt.plot(psig3, val3f[ai,zfi,zmi,0:len(psig),inde,ti+1],'y',linewidth=0.2, label='vm3f') 
    plt.plot(psig0, val0m[ai,zfi,zmi,0:len(psig),inde,ti+1],'k',linewidth=0.2, label='vm0m') 
    plt.plot(psig1, val1m[ai,zfi,zmi,0:len(psig),inde,ti+1],'b',linewidth=0.2, label='vm1m') 
    plt.plot(psig2, val2m[ai,zfi,zmi,0:len(psig),inde,ti+1],'r',linewidth=0.2, label='vm2m') 
    plt.plot(psig3, val3m[ai,zfi,zmi,0:len(psig),inde,ti+1],'y',linewidth=0.2, label='vm3m') 
