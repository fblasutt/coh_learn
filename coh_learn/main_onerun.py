...
if __name__ == '__main__':
    ...
    x0 = np.array([0.30019165039062504,0.29312988281249996,0.9469348144531251, 0.889136962890625,0.08512316894531251,-0.00464412841796875, -0.0414232177734375,1.034232177734375, 0.5877197265625])  
    ...
    x0 = np.array([0.634814453125,0.2867431640625, 0.1960107421875, 0.09401025390625,-0.012556982421875,-0.1328173828125,0.9808105468749999,0.688671875])
    x0 = np.array([0.634814453125,0.2867431640625, 0.0960107421875, 0.09401025390625,-0.012556982421875,-0.1328173828125,0.9808105468749999,0.688671875])
   


    x0 = np.array([ 0.83599853515625,0.16727294921875002,0.6206787109374999,0.356846435546875,-0.0204710693359375,-0.09473876953124999,1.0689208984375,0.47207031250000003])

    x0 = np.array([0.58482971,0.20921271,0.38229169,0.13771209,-0.010143766,-0.12552977,0.96820512,0.42060344])

    #Baseline
    x0 = np.array([0.308482971,0.15921271*1.2,0.18229169,132.53771209,-0.2,-0.12552977,1.7820512,0.62060344*1.2])
    
    x0 = np.array([0.308482971,0.10921271*2.2,0.18229169,152.53771209,-0.2,-0.12552977,1.7820512,0.62060344*2.2])
    
    #Taucehn
    #x0 = np.array([0.308482971,0.15921271*1.2,0.08229169,132.53771209,-0.2,-0.12552977,1.7820512,0.62060344*1.2])
