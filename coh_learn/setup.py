...
class ModelSetup(object):
    def __init__(self,nogrid=False,divorce_costs='Default',separation_costs='Default',draw=False,**kwargs): 
        ...
        p['sig_partner_z'] = 1.5#1.0#0.4 #This is crazy powerful for the diff in diff estimate
        p['sig_partner_mult'] = 1.5
        p['dump_factor_z'] = 0.3#0.78#0.85#0.8
        p['mean_partner_z_female'] = -0.0#+0.03
        ...
        p['u_shift_coh'] =p['u_shift']#-0.00966553
        ...
        if not nogrid:
            ...
            def pens(value):
                ...
                yret=(1.73377+(.8427056/1.224638)*1.73377* 0.3246206)/(1+0.3246206)#np.exp(3.2)#
                thresh1=0.38*yret
                thresh2=1.59*yret
