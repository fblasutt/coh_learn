...
class Agents:
            ...
            for ist,sname in enumerate(self.state_names):
                ...
                def single():
                    ...
                    for eo in grid_edu:
                        ...
                        matches = self.Mlist[ipol].decisions[t][0][ss][eo]
    ...
    #                        
                ...
                def couples():
                    ...
                    ss = self.single_state
                    decision =self.Mlist[ipol].decisions[t][dd][sname]#self.Mlist[ipol].decisions[t][min(dd+1,self.setup.pars['dm']-1)][sname]# 
