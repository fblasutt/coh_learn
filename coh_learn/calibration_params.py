...
def calibration_params(xin=None,xfix=None):
    ...
    params = OrderedDict(
              zlost=(0.55, 0.9, 0.1),
              sigma_psi=(0.1, 0.65, 0.01),#sigma_psi=(0.005, 0.8, 0.01),
              multpsi=(0.01, 0.95, 0.2),#sigma_psi_mult=(0.5, 5.0, 0.02),
              util_alp=(0.001, 0.4, 0.01),#util_alp=(0.01, 0.4, 0.25),
    ...
    params = OrderedDict(
              zlost=(0.15, 0.6, 0.1),
              sigma_psi=(0.05, 0.5, 0.01),#sigma_psi=(0.005, 0.8, 0.01),
              multpsi=(0.1, 0.30, 0.2),#sigma_psi_mult=(0.5, 5.0, 0.02),
              util_alp=(60.0, 120.0, 0.01),#util_alp=(0.01, 0.4, 0.25),
              u_shift=(-0.35, 0.0, 0.01),
