...
def mdl_resid(x=None,save_to=None,load_from=None,return_format=['distance'],
    ...
    W=packed_data['W']
    dat=np.concatenate((hazm_d,hazs_d,hazd_d,everc_d,everm_d,everr_d_d,flsc_d,flsm_d),axis=0)
    ...
    sim=np.concatenate((hazm_s,hazs_s,hazd_s,everc_s,everm_s,everr_d_s,flsc_s,flsm_s),axis=0)
