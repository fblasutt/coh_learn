...
#matrixes coming from simulations    
    ...
    if draw:  
        ...
        agea=np.array(range(lend))+20 
        plt.scatter(agea[:-2], inc_men['wtmedian'][:-2], marker='o',color='b',s=60, facecolors='none',  label='Data') 
        plt.plot(agea[:-2], log_inc_rel[0,1,:lend-2],'r',markersize=6, label='Simulations')
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15),    
                  fancybox=True, shadow=True, ncol=2, fontsize=14)    
        ...
        plt.scatter(agea[:-2], inc_men['wtmedian'][:-2], marker='o',color='b',s=60, facecolors='none', label='Data') 
        plt.plot(agea[:-2], log_inc_rel[1,1,:lend-2],'r',markersize=6, label='Simulations')
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15),    
                  fancybox=True, shadow=True, ncol=2, fontsize=14)    
        plt.xlabel('Age', fontsize=16)    
        plt.ylabel('Average log wage', fontsize=16)
        ...
        plt.scatter(agea[:-2], inc_women['wtmedian'][:-2], marker='o',color='b',s=60, facecolors='none', label='Data') 
        plt.plot(agea[:-2], log_inc_rel[1,0,mdl.setup.pars['Tbef']:lend+mdl.setup.pars['Tbef']-2],'r',markersize=6, label='Simulations')
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15),    
                  fancybox=True, shadow=True, ncol=2, fontsize=14)    
        plt.xlabel('Age', fontsize=16)    
        plt.ylabel('Average log wage', fontsize=16)
        ...
        plt.scatter(agea[:-2], inc_women['wtmedian'][:-2], marker='o',color='b',s=60, facecolors='none', label='Data') 
        plt.plot(agea[:-2], log_inc_rel[0,0,mdl.setup.pars['Tbef']:lend+mdl.setup.pars['Tbef']-2],'r',markersize=6, label='Simulations')
        plt.legend(loc='upper center', bbox_to_anchor=(0.5, -0.15),    
                  fancybox=True, shadow=True, ncol=2, fontsize=14)    
        plt.xlabel('Age', fontsize=16)    
        plt.ylabel('Average log wage', fontsize=16)
