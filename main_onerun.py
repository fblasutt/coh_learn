...
if __name__ == '__main__':
    ...
    x0 = np.array([0.254532226562499996, 0.0,0.205250547890625,  12.1,-0.0, -0.05, 1.5,1.8])
    x0 = np.array([0.254532226562499996, 0.0,1.15250547890625,  59.01,-2.1, -0.05, 1.5,1.8])
    ...
    #Below cost oìfor edu 0.6- 0.2
    #x0 = np.array([0.0094054532226562499996, 0.0,0.399547890625,  0.1,0.0,-0.15, 1.5,1.3])
    
    #x0 = np.array([0.354532226562499996, 0.0,0.50547890625,  0.7,-0.0,0.0, 3.2,1.3])
